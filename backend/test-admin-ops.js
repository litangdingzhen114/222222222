...
async function main() {
  ...
  assert.strictEqual(namingProfile.body.data.activeProfile.cafeName, '寻野村咖');
  ...
  assert(legacyNamedHomeText.includes('海林村'), 'legacy naming requests should stay on Hailin wording');
