  ...
  const mapPoints = [
    {
      ...
      description: '海林村入口服务点，可承接游客咨询、路线导览和活动集合。',
      businessHours: '08:30-18:00',
      sort: 1,
    },
    {
      id: 'mp-tianpu-station',
      name: '田铺驿站',
      type: MapPointType.SERVICE_CENTER,
    ...
    },
    {
      ...
      description: '海林·溪谷串联亲水慢行、石桥、竹林和户外活动空间，适合露营、团建和亲子活动。',
      businessHours: '全天开放',
...
async function seedReservations() {
  ...
  const names = ['海林村草莓园', '溪畔茶园', '鱼稻共生体验田'];
  ...
  for (let index = 0; index < cameras.length; index += 1) {
    ...
    await prisma.camera.upsert({
      ...
      create: {
        ...
        channelNo: 1,
        location,
        description: `${location}实时画面由后台视频服务统一维护。`,
...
async function seedProducts() {
  ...
  const categories = [
    ['cat-farm', '农品预购', 'sprout'],
    ['cat-meat', '土鸡黑猪', 'package'],
    ['cat-honey', '土蜂蜜蛋品', 'honey'],
    ['cat-gift', '乡村伴手礼', 'gift'],
  ] as const;
  ...
  const products = [
    [
      ...
      42,
      '约2.5斤/只',
      '/assets/photos/ai-product-native-chicken.jpg',
    ],
    [
      'product-native-eggs',
      '农家土鸡蛋',
      ...
      88,
      '30枚/盒',
      '/assets/photos/ai-product-native-eggs.jpg',
    ],
    [
      'product-black-pork',
      '山乡黑猪肉',
      ...
      36,
      '1斤起订',
      '/assets/photos/ai-product-black-pork.jpg',
    ],
    [
      'product-honey',
      '海林村土蜂蜜',
      ...
      64,
      '500g/瓶',
      '/assets/photos/ai-product-honey.jpg',
    ],
    [
      'product-rice',
      '海林村生态米',
