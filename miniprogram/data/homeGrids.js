const pageOne = [
  ...
  { id: 'weather', title: '海口天气', icon: '晴', iconPath: '/assets/icons/weather.png', url: '/pages/map/map', openType: 'switchTab' },
  { id: 'traffic', title: '交通指南', icon: '行', iconPath: '/assets/icons/traffic.png', url: '/pages/map/map', openType: 'switchTab' },
  { id: 'photo', title: 'AI旅拍', icon: '拍', iconPath: '/assets/icons/photo.png', url: '/pages/ai-guide/ai-guide' },
  { id: 'overseas', title: '侨乡故事', icon: '侨', iconPath: '/assets/icons/overseas.png', url: '/pages/spot-detail/spot-detail?id=museum' },
  ...
  { id: 'travel', title: '出行服务', icon: '车', iconPath: '/assets/icons/travel.png', url: '/pages/map/map', openType: 'switchTab' },
  { id: 'live', title: '海林慢直播', icon: '播', iconPath: '/assets/icons/live.png', url: '/pages/live-list/live-list' },
  { id: 'story', title: '海林故事', icon: '故', iconPath: '/assets/icons/story.png', url: '/pages/spot-detail/spot-detail?id=museum' },
  { id: 'commerce', title: '共富集市', icon: '市', iconPath: '/assets/icons/commerce.png', url: '/pages/mine-feature/mine-feature?id=mall' }
];

const pageTwo = [
  { id: 'pay', title: '乡心支付', icon: '付', iconPath: '/assets/icons/pay.png', url: '/pages/mine-feature/mine-feature?id=mall' },
  { id: 'culture', title: '文化云', icon: '云', iconPath: '/assets/icons/culture.png', url: '/pages/spot-list/spot-list' },
  ...
  { id: 'team', title: '团建定制游', icon: '团', iconPath: '/assets/icons/team.png', url: '/pages/booking/booking' },
  { id: 'luggage', title: '行李无忧', icon: '寄', iconPath: '/assets/icons/luggage.png', url: '/pages/mine-feature/mine-feature?id=guide' },
