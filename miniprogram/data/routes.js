const routeDetails = {
  ...
  "one-day": {
    included: ["村情馆讲解", "稻鱼田观景", "古树年轮拓印", "溪畔茶歇与伴手礼"],
    prepares: [
      "建议穿适合步行的鞋，全天路线点位较多。",
      "手作课程需提前确认人数和材料。",
      "摄影团队可备注想要的拍摄时段。",
  ...
  food: {
    included: ["稻鱼生态讲解", "田鱼家宴预约", "共富集市选购", "土狗咖啡 收尾"],
    prepares: [
      "请提前备注忌口、老人儿童人数和用餐时间。",
      "团队用餐建议至少提前一天确认桌数。",
      "伴手礼可选择到村自提或统一打包。",
...
const routes = [
  {
    id: "half-day",
    name: "瓯江山村半日游",
    subtitle: "从黄湖林场入村，串联会客点、溪谷步道和田鱼家宴",
    reason:
      "适合首次到访游客，用半天时间感受黄湖林场的区位、山水、村落和黄湖林场乡味。",
    duration: "约 4 小时",
    ...
    timeline: [
      {
        time: "09:30",
        title: "游客中心集合",
        desc: "领取导览地图，了解当天活动提示。",
      },
      {
        time: "10:00",
        title: "村口会客点打卡",
        desc: "拍摄村牌与导览牌，了解黄湖林场区位。",
      },
      {
        time: "11:00",
        title: "溪谷步道慢行",
  ...
  },
  {
    id: "one-day",
    name: "古树年轮一日游",
    subtitle: "村情馆、稻鱼田、古树年轮拓印全体验",
    reason: "串联黄湖林场文化、山村风景和体验点，适合想深入了解黄湖林场的游客。",
    duration: "约 8 小时",
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: "15:00", title: "土狗咖啡", desc: "以咖啡、米糕和乡野轻食收尾。" },
    ],
  },
];
