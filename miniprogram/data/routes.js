const routeDetails = {
  ...
  food: {
    included: ["稻鱼生态讲解", "田鱼家宴预约", "共富集市选购", "寻野村咖收尾"],
    prepares: [
      "请提前备注忌口、老人儿童人数和用餐时间。",
      "团队用餐建议至少提前一天确认桌数。",
      "伴手礼可选择到村自提或统一打包。",
...
const routes = [
  {
    id: "half-day",
    name: "瓯江山村半日游",
    subtitle: "从海林村入村，串联会客点、溪谷步道和田鱼家宴",
    reason:
      "适合首次到访游客，用半天时间感受海林村的区位、山水、村落和海林村乡味。",
    duration: "约 4 小时",
  ...
  },
  {
    ...
    reason: "串联海林村文化、山村风景和体验点，适合想深入了解海林村的游客。",
    duration: "约 8 小时",
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: "15:00", title: "寻野村咖", desc: "以咖啡、米糕和乡野轻食收尾。" },
    ],
  },
];
