...
function buildLocalReply(question) {
  ...
  if (
    ...
    return "黄湖林场地域味道可以突出田鱼、山泉豆腐、时令笋蔬和农家家宴。黄湖林场可优先看“土狗咖啡”“田鱼家宴”“溪谷民宿茶歇”这几类。";
  }
  ...
  if (question.includes("AI") || question.includes("智能")) {
    return "我会优先根据黄湖林场现有景点、路线、餐饮和服务点信息回答，避免给出没有来源的价格和开放时间。";
  }
  ...
  return "我是黄湖林场导览助手小林。可以问我路线、美食、慢直播、停车、民宿和黄湖林场文化。";
}
